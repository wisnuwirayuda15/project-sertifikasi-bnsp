  ...
  @push('scripts')
    <script>
      $(document).ready(function() {
        ...
        selectInput('https://www.emsifa.com/api-wilayah-indonesia/api/provinces.json', '#provinsi_lahir', '{{ $user->provinsi_lahir }}');
        $('#kabupaten').append(`<option>{{ $user->kabupaten }}</option>`);
        $('#kecamatan').append(`<option>{{ $user->kecamatan }}</option>`);
        $('#kota_lahir').append(`<option>{{ $user->kota_lahir }}</option>`);
